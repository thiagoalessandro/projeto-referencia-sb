package br.com.packagebase.projetoreferenciasb.repository.specification;
...
import br.com.packagebase.projetoreferenciasb.repository.specification.enums.RsqlSearchOperation;
...
public class GenericRsqlSpecification<T> implements Specification<T> {
    ...
    private List<Object> castArguments(final Root<T> root) {
        ...
        return arguments.stream().map(arg -> {
            ...
            } else if (type.equals(DominioOperacao.class)) {
                return DominioOperacao.valueOf(arg);
